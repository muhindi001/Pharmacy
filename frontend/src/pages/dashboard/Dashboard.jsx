...
<div className="mt-8">
    ...
    <LowStockTable
        medicines={dashboard.low_stock_list}
    />
...
<div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mt-8">
    ...
    <ExpiryTable
        medicines={dashboard.expiring_medicines}
    />

    <AlertsCard
        alerts={dashboard.alert_list}
    />

    <WarehouseCard
        warehouses={dashboard.warehouse_summary}
    />
...
<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
    ...
    <TopMedicines
        medicines={dashboard.top_medicines}
    />
