...
path("purchases/monthly/",MonthlyPurchaseReportView.as_view(),name="monthly-purchase-report",),
path("purchases/yearly/",YearlyPurchaseReportView.as_view(),name="yearly-purchase-report",),
path("purchases/suppliers/",PurchasesBySupplierReportView.as_view(),name="purchases-by-supplier-report",),
path("purchases/cost-analysis/",PurchaseCostAnalysisReportView.as_view(),name="purchase-cost-analysis-report",),
path("purchases/top-medicines/",TopPurchasedMedicinesReportView.as_view(),name="top-purchased-medicines-report",),
path("purchases/outstanding/",OutstandingPurchasesReportView.as_view(),name="outstanding-purchases-report",),
path("purchases/search/",SearchPurchaseReportView.as_view(),name="search-purchase-report",),
...
path("exports/sales/excel/",SalesExcelView.as_view(),name="sales-excel",),
# ==========================
# Export Reports
# ==========================

path("exports/sales/pdf/",SalesPDFExportView.as_view(),name="sales-export-pdf",),
path("exports/sales/excel/",SalesExcelExportView.as_view(),name="sales-export-excel",),
path("exports/sales/csv/",SalesCSVExportView.as_view(),name="sales-export-csv",),
]